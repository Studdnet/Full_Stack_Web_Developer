...
хватает для отопления всего объема торгового центра - выводится 'Бюджета достаточно', 
...
Сделать одно решение с помощью деструктуризации объекта.
*/
...
function isBudgetEnough(data) {
  ...
  let volumeRooms = sumAreas * data.height;
  let costHeating = volumeRooms * data.moneyPer1m3;
  if (costHeating <= data.budget) {
